...
import kotlinx.android.synthetic.main.dialog_fingerprint_open.*

/**
 * Created by CodeLab
 */
class FpOpenDialogFg : BaseDialogFg() {
    ...
    override fun onInitView() {
        fingerprint_open_cancel.setOnClickListener {
            dismiss()
            mListener!!.onFingerprintListener(0)
        }
        fingerprint_open_confirm.setOnClickListener {
            dismiss()
    ...
    companion object {
        @JvmStatic
        fun newInstance(): FpOpenDialogFg {
            return FpOpenDialogFg()
        }
    }
}