...
public final class UserUtil {
    ...
    public static UserBean getLocalUser(Context context, String openId) {
        String localStr = (String) SPUtil.get(context, openId, "");
        if (TextUtils.isEmpty(localStr)) {
            return null;
        }
        try {
            return new Gson().fromJson(localStr, new TypeToken<UserBean>() {
            }.getType());
